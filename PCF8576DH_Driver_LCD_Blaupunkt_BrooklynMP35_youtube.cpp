...
void HiFolksArray(void){
  ...
  text[6]=(letterF[0]  | letter_[2]);   text[7]= letterF[1];             // 7xx, 8xx,
  text[8]=(letterO[0]  | letterF[2]);   text[9]= letterO[1];             // 9xx, Axx, 
  text[10]=(letterO[0] | letterO[2]);   text[11]=letterO[1];             // Bxx, Cxx, 
  text[12]=(letterL[0] | letterO[2]);   text[13]=letterL[1];             // Dxx, Exx,
  text[14]=(letterK[0] | letterL[2]);   text[15]=letterK[1];            // Fxx, Gxx,
  text[16]=(letterS[0] | letterK[2]);   text[17]=letterS[1]; text[18]=letterS[2];  // Hxx, Ixx, Jxx
